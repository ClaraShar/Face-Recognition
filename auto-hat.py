...
print("Found {} face(s) in this phtotgraph.".format(len(face_locations)))
...
for face_location in face_locations:
	...
	top-=10
	print("A face is located at pixel location Top:{},Left:{},Bottom:{},Rigth:{}".format(top,left,bottom,right))
